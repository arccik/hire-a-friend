      ...
      <div id="menu" className="my-5 flex flex-col space-y-2">
          ...
          <div className="flex flex-col items-center space-x-2 space-y-2 md:flex-row md:space-y-0">
            <div>
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className="h-6 w-6 group-hover:text-indigo-400"
              >
                <path
                  strokeLinecap="round"
            ...
            <div>
              <p className="text-base font-bold leading-4 text-slate-200 group-hover:text-indigo-400 lg:text-lg">
                Dashboard
              </p>
        ...
        >
          <div className="relative flex flex-col items-center space-x-2 space-y-2 md:flex-row md:space-y-0">
            ...
            <div className="absolute -right-3 -top-3 rounded-full bg-indigo-800 px-2 py-1.5 font-mono text-xs font-bold md:right-0 md:top-0">
              23
            </div>
          </div>
        </a>
