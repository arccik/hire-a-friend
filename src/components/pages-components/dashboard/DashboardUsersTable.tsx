      ...
      <div className="overflow-x-scroll">
        <table className="w-full whitespace-nowrap">
          ...
          <tr className="border-b border-gray-700">
            ...
            <td className="px-2 py-3">thai.mei@abc.com</td>
            <td className="px-2 py-3">User</td>
            <td className="px-2 py-3">Approved</td>
          ...
          <tr className="border-b border-gray-700">
            ...
            <td className="px-2 py-3">marquez.spineli@cba.com</td>
            <td className="px-2 py-3">User</td>
            <td className="px-2 py-3">Approved</td>
            <td className="px-2 py-3">
              <div className="inline-flex items-center space-x-3">
          ...
          <tr className="border-b border-gray-800">
            ...
            <td className="px-2 py-3">mark.spike@abc.com</td>
            <td className="px-2 py-3">Administrator</td>
            <td className="px-2 py-3">Approved</td>
            <td className="px-2 py-3">
              <div className="inline-flex items-center space-x-3">
                <a href="" title="Edit" className="hover:text-white">
